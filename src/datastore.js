...
// import action names
const ACTIONS = ["createIdentity","createTask","destroyCompletedTasks","destroyTask","lookupIdentity","markTaskComplete","markTaskIncomplete","setTaskText","toggleAllTasks"];
